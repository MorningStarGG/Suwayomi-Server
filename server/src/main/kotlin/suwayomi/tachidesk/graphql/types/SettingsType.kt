...
interface Settings : Node {
    ...
    // webUI
    //    requires restart (found no way to mutate (serve + "unserve") served files during runtime),
    // exclude for now
    ...
    // formats
    val mangaFolderFormat: String?
    val chapterFolderFormat: String?
    val cbzFileFormat: String?
    ...
    @GraphQLDeprecated("Removed - does not do anything") val gqlDebugLogsEnabled: Boolean?
...
data class PartialSettingsType(
        ...
        // formats
        override val mangaFolderFormat: String?,
        override val chapterFolderFormat: String?,
        override val cbzFileFormat: String?,
        // extension
...
class SettingsType(
    ...
    constructor(
            ...
            // formats
            config.mangaFolderFormat.value,
            config.chapterFolderFormat.value,
            config.cbzFileFormat.value,
            // extension
